...
if(isset($_POST['submit']))
  {
   // $id=$_SESSION['u_id'];
   {
    ...
    $query=mysqli_query($db, "SELECT * FROM  `Expense_tbl` (`ExpenseDate`,  `ExpenseCost`,`userid`) VALUES ('$dateexpense','$item','$costitem')");
}
  ?>
<!DOCTYPE html>
<html>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="expense-monthwise-reports-detailed-of-user.php" name="bwdatesreport">
