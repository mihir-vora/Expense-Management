	...
	<div class="panel panel-default">
	  <div class="panel-heading" style="color:blue"><b>Monthwise Expense   		Report</b></div>
        ...
        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		   ...
		   <?php
		        // $id=$_SESSION['u_id'];
				$ret=mysqli_query($db,"SELECT UserId, month(ExpenseDate) as rptmonth,year(ExpenseDate) as rptyear,SUM(ExpenseCost) as totalmonth FROM `Expense_tbl`  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (`UserId`) group by month(ExpenseDate),year(ExpenseDate)");
			   $cnt=1;
